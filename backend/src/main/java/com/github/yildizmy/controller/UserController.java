...
public class UserController {
     ...
     */
    @PreAuthorize("hasRole(T(com.github.yildizmy.domain.enums.RoleType).ROLE_ADMIN)")
    @GetMapping
     ...
     * @param id
     */
    @PreAuthorize("hasAnyRole(T(com.github.yildizmy.domain.enums.RoleType).ROLE_ADMIN)")
    @DeleteMapping("/{id}")
