...
> **Warning** <br/>
> Before running this command, delete previously composed containers (`db`, `backend` and `frontend`), images (`pet-clinic-backend` and `pet-clinic-frontend`) and volumes (`pet-clinic_db-data`) belonging to the application. 
